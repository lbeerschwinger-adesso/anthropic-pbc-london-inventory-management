...
/* Chart series colors mapped to design tokens */
.legend-dot.procurement { background: var(--color-primary); }
.legend-dot.operational { background: var(--color-violet); }
...
/* Stacked bar segment colors mapped to design tokens */
.bar-segment.procurement { background: var(--color-primary); }
.bar-segment.operational { background: var(--color-violet); }
